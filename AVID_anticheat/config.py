...
jdbc:redshift://sta-event-game-publish.ciemeqgcfm18.us-west-2.redshift.amazonaws.com:5439/event
"""
...
class MysqlConfig:
    DBHOST = "test-holagames.cnurzh37opih.us-west-2.rds.amazonaws.com"
    DBPORT = 3306
    DBUSER = "mesh"
    DBPWD = "r76dG6CbpbBvt5I7MH0T"
    DBNAME = "mesh"
    DBCHAR = "utf8"
