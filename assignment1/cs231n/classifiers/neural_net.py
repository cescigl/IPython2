...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    #############################################################################
    l1score=X.dot(W1)+b1
    hidden_scores=np.maximum(l1score, 0)
    ...
    dHidden_dLayer1 = np.zeros_like(l1score)
    dHidden_dLayer1[l1score > 0] = 1
  ...
  def predict(self, X):
    ...
    hidd = np.maximum(l1, 0)
    scores = hidd.dot(self.params['W2']) + self.params['b2']
